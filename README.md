...
- [ansidev/anti-locker](https://github.com/ansidev/anti-locker) ([v1.0.2](https://github.com/ansidev/anti-locker/releases/tag/v1.0.2), today) - Prevent macOS from locking the screen when connected to a specific Wi-Fi network.
- [ghacts/go](https://github.com/ghacts/go) ([v2.0.0](https://github.com/ghacts/go/releases/tag/v2.0.0), today) - GitHub Actions for building and testing Go projects
...
- [Merge branch release/1.0.2 into develop](https://github.com/ansidev/anti-locker/pull/6) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (today)
- [Release v1.0.2](https://github.com/ansidev/anti-locker/pull/5) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (today)
- [Merge branch release/1.0.1 into develop](https://github.com/ansidev/anti-locker/pull/4) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (today)
- [Release v2.0.0](https://github.com/ghacts/go/pull/2) on [ghacts/go](https://github.com/ghacts/go) (today)
- [Release v1.0.1](https://github.com/ansidev/anti-locker/pull/3) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (today)
