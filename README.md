...
- [ansidev/changelog-config-starter](https://github.com/ansidev/changelog-config-starter) - An opinionated configuration for changelog management (6 days ago)
...
- [withastro/astro](https://github.com/withastro/astro) ([@astrojs/vercel@3.7.0](https://github.com/withastro/astro/releases/tag/%40astrojs/vercel%403.7.0), 2 days ago) - The all-in-one web framework designed for speed. ⭐️ Star to support our work!
- [astro-community/astro-compress](https://github.com/astro-community/astro-compress) ([v1.1.49](https://github.com/astro-community/astro-compress/releases/tag/v1.1.49), 5 days ago) - 🗜️ AstroJS compression utilities. Compress CSS, HTML, JavaScript and more!
