...
- [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ([v4.5.0](https://github.com/akinsho/bufferline.nvim/releases/tag/v4.5.0), 6 days ago) - A snazzy bufferline for Neovim
- [astro-community/AstroCompress](https://github.com/astro-community/AstroCompress) ([v2.2.8](https://github.com/astro-community/AstroCompress/releases/tag/v2.2.8), 2 weeks ago) - 🗜️ AstroJS compression utilities. Compress CSS, HTML, JavaScript and more!
- [ghacts/manual-deploy-to-netlify](https://github.com/ghacts/manual-deploy-to-netlify) ([v1.0.1](https://github.com/ghacts/manual-deploy-to-netlify/releases/tag/v1.0.1), 3 weeks ago) - GitHub Actions for manual deploying static site projects to Netlify
