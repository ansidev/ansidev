...
- [ansidev/prompt-master](https://github.com/ansidev/prompt-master) - This is the cloned agent skill of `nidhinjs/prompt-master` to make it compatible with `gh skill install` command (2 days ago)
...
- [ansidev/anti-locker](https://github.com/ansidev/anti-locker) ([v1.0.3](https://github.com/ansidev/anti-locker/releases/tag/v1.0.3), 3 weeks ago) - Prevent macOS from locking the screen when connected to a specific Wi-Fi network.
- [ghacts/go](https://github.com/ghacts/go) ([v2.0.0](https://github.com/ghacts/go/releases/tag/v2.0.0), 4 weeks ago) - GitHub Actions for building and testing Go projects
...
- [Translate Chinese to English and correct label text](https://github.com/Eddie0521/pi-permission-suite/pull/1) on [Eddie0521/pi-permission-suite](https://github.com/Eddie0521/pi-permission-suite) (6 days ago)
...
- [Merge branch release/1.0.2 into develop](https://github.com/ansidev/anti-locker/pull/6) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (4 weeks ago)
- [Release v1.0.2](https://github.com/ansidev/anti-locker/pull/5) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (4 weeks ago)
