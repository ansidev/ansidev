...
- [withastro/astro](https://github.com/withastro/astro) ([@astrojs/mdx@1.0.2](https://github.com/withastro/astro/releases/tag/%40astrojs/mdx%401.0.2), 2 days ago) - The all-in-one web framework designed for speed. ⭐️ Star to support our work!
- [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) ([v2.0.0](https://github.com/ansidev/astro-basic-template/releases/tag/v2.0.0), 5 days ago) - An opinionated Astro starter template
...
- [Merge branch release/2.0.0 into develop](https://github.com/ansidev/astro-basic-template/pull/316) on [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) (5 days ago)
- [Release v2.0.0](https://github.com/ansidev/astro-basic-template/pull/315) on [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) (5 days ago)
- [feat: config TypeScript](https://github.com/ansidev/astro-basic-template/pull/314) on [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) (5 days ago)
