...
- [ansidev/gh-env-sync](https://github.com/ansidev/gh-env-sync) - GitHub Actions Secrets & Variables Synchronization Tool (3 weeks ago)
- [ansidev/awesome-nuxt](https://github.com/ansidev/awesome-nuxt) - 🎉 A curated list of awesome things related to Nuxt.js (1 month ago)
...
- [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) ([v3.1.1](https://github.com/ansidev/astro-basic-template/releases/tag/v3.1.1), 11 months ago) - An opinionated Astro starter template

#### 🔨 Latest Pull Requests I published

- [Feature: Migrate to rolldown from tsup](https://github.com/ansidev/counter-analytics-vue/pull/340) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (1 week ago)
- [fix: migrate deprecated Astro v5 Content Layer APIs](https://github.com/ansidev/leetcode-blog/pull/1412) on [ansidev/leetcode-blog](https://github.com/ansidev/leetcode-blog) (3 weeks ago)
- [fix: remove pnpm version to avoid failed CI/CD pipelines](https://github.com/ansidev/counter-analytics-vue/pull/333) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (3 weeks ago)
- [fix: remove pnpm version to avoid failed CI/CD pipelines](https://github.com/ansidev/leetcode-blog/pull/1411) on [ansidev/leetcode-blog](https://github.com/ansidev/leetcode-blog) (3 weeks ago)
- [fix: remove pnpm version to avoid failed CI/CD pipelines](https://github.com/ansidev/astro-basic-template/pull/1215) on [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) (3 weeks ago)
