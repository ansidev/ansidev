...
- [prismicio/prismic-client](https://github.com/prismicio/prismic-client) ([v6.8.0](https://github.com/prismicio/prismic-client/releases/tag/v6.8.0), 1 day ago) - The official JavaScript + TypeScript client library for Prismic
...
- [optimize: upgrade example hz/protobuf using hz v0.6.3](https://github.com/cloudwego/hertz-examples/pull/97) on [cloudwego/hertz-examples](https://github.com/cloudwego/hertz-examples) (5 days ago)
- [fix(shell-integration): support Alacritty v0.11.0 and newer](https://github.com/desktop/desktop/pull/16676) on [desktop/desktop](https://github.com/desktop/desktop) (6 days ago)
- [fix: typo error](https://github.com/ansidev/hertz-swagger/pull/1) on [ansidev/hertz-swagger](https://github.com/ansidev/hertz-swagger) (6 days ago)
