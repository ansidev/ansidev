...
- [ansidev/resume-cli-ce](https://github.com/ansidev/resume-cli-ce) (2 days ago)
- [ansidev/changelog-config-starter](https://github.com/ansidev/changelog-config-starter) - An opinionated configuration for changelog management (2 days ago)
...
- [astro-community/astro-compress](https://github.com/astro-community/astro-compress) ([v1.1.48](https://github.com/astro-community/astro-compress/releases/tag/v1.1.48), 3 days ago) - 🗜️ AstroJS compression utilities. Compress CSS, HTML, JavaScript and more!
- [withastro/astro](https://github.com/withastro/astro) ([@astrojs/markdoc@0.4.0](https://github.com/withastro/astro/releases/tag/%40astrojs/markdoc%400.4.0), 3 days ago) - The all-in-one web framework designed for speed. ⭐️ Star to support our work!
- [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ([v4.2.0](https://github.com/akinsho/bufferline.nvim/releases/tag/v4.2.0), 6 days ago) - A snazzy bufferline for Neovim
