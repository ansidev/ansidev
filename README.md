...
- [safestudio/seat-diagram-app](https://github.com/safestudio/seat-diagram-app) - Seat Digram App (4 days ago)
- [ansidev/vue-ui-ideas](https://github.com/ansidev/vue-ui-ideas) - Vue UI Ideas (4 days ago)
- [ansidev/template-vite-vue-tailwind](https://github.com/ansidev/template-vite-vue-tailwind) - Vite, Vue 3, TS, Tailwind (1 week ago)
- [ansidev/nuxt-bpmn-demo](https://github.com/ansidev/nuxt-bpmn-demo) - A NuxtJS based BPMN modeler (1 week ago)
...
- [astro-community/AstroCompress](https://github.com/astro-community/AstroCompress) ([v2.2.0](https://github.com/astro-community/AstroCompress/releases/tag/v2.2.0), 3 days ago) - 🗜️ AstroJS compression utilities. Compress CSS, HTML, JavaScript and more!
- [withastro/astro](https://github.com/withastro/astro) ([astro@3.4.0](https://github.com/withastro/astro/releases/tag/astro%403.4.0), 6 days ago) - The web framework that scales with you — Build fast content sites, powerful web applications, dynamic server APIs, and everything in-between ⭐️ Star to support our work!
- [prismicio/prismic-client](https://github.com/prismicio/prismic-client) ([v7.3.1](https://github.com/prismicio/prismic-client/releases/tag/v7.3.1), 3 weeks ago) - The official JavaScript + TypeScript client library for Prismic
