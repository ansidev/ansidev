...
- [ansidev/sample-gitflow-release-workflows](https://github.com/ansidev/sample-gitflow-release-workflows) - Sample Gitflow release workflows using GitHub Actions and official GitHub CLI (3 days ago)
...
- [ghacts/manual-deploy-to-netlify](https://github.com/ghacts/manual-deploy-to-netlify) ([v1.0.0](https://github.com/ghacts/manual-deploy-to-netlify/releases/tag/v1.0.0), 2 days ago) - GitHub Actions for manual deploying static site projects to Netlify
- [ghacts/static-site](https://github.com/ghacts/static-site) ([v1.0.0](https://github.com/ghacts/static-site/releases/tag/v1.0.0), 2 days ago) - GitHub Actions for building and testing static site projects
- [ghacts/go](https://github.com/ghacts/go) ([v1.0.0](https://github.com/ghacts/go/releases/tag/v1.0.0), 2 days ago) - GitHub Actions for building and testing Go projects
- [withastro/astro](https://github.com/withastro/astro) ([@astrojs/lit@2.1.0](https://github.com/withastro/astro/releases/tag/%40astrojs/lit%402.1.0), 3 days ago) - The all-in-one web framework designed for speed. ⭐️ Star to support our work!
- [ansidev/leetcode-blog](https://github.com/ansidev/leetcode-blog) ([v2.2.5](https://github.com/ansidev/leetcode-blog/releases/tag/v2.2.5), 3 days ago) - Solutions for LeetCode problems - Written by ansidev

#### 🔨 Latest Pull Requests I published

- [Release v1.0.0](https://github.com/ghacts/manual-deploy-to-netlify/pull/1) on [ghacts/manual-deploy-to-netlify](https://github.com/ghacts/manual-deploy-to-netlify) (2 days ago)
- [Release v1.0.0](https://github.com/ghacts/static-site/pull/1) on [ghacts/static-site](https://github.com/ghacts/static-site) (2 days ago)
- [Release v1.0.0](https://github.com/ghacts/go/pull/1) on [ghacts/go](https://github.com/ghacts/go) (2 days ago)
- [fix(github-workflow): adjust trigger deploy condition](https://github.com/ansidev/awesome-nuxt/pull/149) on [ansidev/awesome-nuxt](https://github.com/ansidev/awesome-nuxt) (2 days ago)
- [feat(github-workflow): automate deploying site to Netlify](https://github.com/ansidev/awesome-nuxt/pull/148) on [ansidev/awesome-nuxt](https://github.com/ansidev/awesome-nuxt) (2 days ago)
