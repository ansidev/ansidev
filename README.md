...
- [withastro/astro](https://github.com/withastro/astro) ([@astrojs/cloudflare@6.8.1](https://github.com/withastro/astro/releases/tag/%40astrojs/cloudflare%406.8.1), 1 day ago) - The all-in-one web framework designed for speed. ⭐️ Star to support our work!
- [astro-community/AstroCompress](https://github.com/astro-community/AstroCompress) ([v2.0.14](https://github.com/astro-community/AstroCompress/releases/tag/v2.0.14), 6 days ago) - 🗜️ AstroJS compression utilities. Compress CSS, HTML, JavaScript and more!
- [prismicio/prismic-client](https://github.com/prismicio/prismic-client) ([v7.1.1](https://github.com/prismicio/prismic-client/releases/tag/v7.1.1), 2 weeks ago) - The official JavaScript + TypeScript client library for Prismic
