...
- [ansidev/homebrew-casks](https://github.com/ansidev/homebrew-casks) - ansidev's Homebrew Casks (3 days ago)
...
- [ghacts/manual-deploy-to-netlify](https://github.com/ghacts/manual-deploy-to-netlify) ([v1.0.1](https://github.com/ghacts/manual-deploy-to-netlify/releases/tag/v1.0.1), 4 days ago) - GitHub Actions for manual deploying static site projects to Netlify
- [withastro/astro](https://github.com/withastro/astro) ([astro@4.1.1](https://github.com/withastro/astro/releases/tag/astro%404.1.1), 5 days ago) - The web framework that scales with you — Build fast content sites, powerful web applications, dynamic server APIs, and everything in-between ⭐️ Star to support our work!
- [astro-community/AstroCompress](https://github.com/astro-community/AstroCompress) ([v2.2.7](https://github.com/astro-community/AstroCompress/releases/tag/v2.2.7), 5 days ago) - 🗜️ AstroJS compression utilities. Compress CSS, HTML, JavaScript and more!
...
- [deps: eslint & husky](https://github.com/ansidev/counter-analytics-vue/pull/97) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (3 days ago)
- [deps: vue 3.4.5](https://github.com/ansidev/counter-analytics-vue/pull/96) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (3 days ago)
- [chore(deps): bump tsup version to ^8.0.1](https://github.com/ansidev/counter-analytics-vue/pull/95) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (3 days ago)
- [deps: typescript 5.3.3](https://github.com/ansidev/counter-analytics-vue/pull/94) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (3 days ago)
- [chore(deps): upgrade @commitlint packages to v18](https://github.com/ansidev/counter-analytics-vue/pull/93) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (3 days ago)
