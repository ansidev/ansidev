...
- [prismicio/prismic-client](https://github.com/prismicio/prismic-client) ([v6.9.0](https://github.com/prismicio/prismic-client/releases/tag/v6.9.0), 3 days ago) - The official JavaScript + TypeScript client library for Prismic
- [withastro/astro](https://github.com/withastro/astro) ([@astrojs/telemetry@3.0.2](https://github.com/withastro/astro/releases/tag/%40astrojs/telemetry%403.0.2), 3 days ago) - The web framework that scales with you — Build fast content sites, powerful web applications, dynamic server APIs, and everything in-between ⭐️ Star to support our work!
- [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ([v4.4.0](https://github.com/akinsho/bufferline.nvim/releases/tag/v4.4.0), 4 days ago) - A snazzy bufferline for Neovim
