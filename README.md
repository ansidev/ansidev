...
- [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) ([v1.0.3](https://github.com/ansidev/astro-basic-template/releases/tag/v1.0.3), 3 days ago) - An opinionated Astro starter template
- [swaggo/swag](https://github.com/swaggo/swag) ([v1.8.11](https://github.com/swaggo/swag/releases/tag/v1.8.11), 4 days ago) - Automatically generate RESTful API documentation with Swagger 2.0 for Go.
...
- [fix(changelog): correct changelog v1.0.3](https://github.com/ansidev/astro-basic-template/pull/104) on [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) (2 days ago)
- [Merge branch 'release/1.0.3' into develop](https://github.com/ansidev/astro-basic-template/pull/103) on [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) (3 days ago)
- [Release v1.0.3](https://github.com/ansidev/astro-basic-template/pull/102) on [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) (3 days ago)
- [feat(renovate): change renovate update dependency strategy](https://github.com/ansidev/astro-basic-template/pull/101) on [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) (3 days ago)
- [build(deps): update typescript to version 5.0.2](https://github.com/ansidev/astro-basic-template/pull/100) on [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) (3 days ago)
