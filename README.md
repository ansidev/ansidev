...
- [heyhuynhgiabuu/proxypal](https://github.com/heyhuynhgiabuu/proxypal) - A desktop app that lets you use your AI subscriptions (Claude, ChatGPT, Gemini, GitHub Copilot) with any coding tool. Wraps CLIProxyAPI with a clean UI for managing connections and tracking usage. (1 month ago)
- [ansidev/gh-env-sync](https://github.com/ansidev/gh-env-sync) - GitHub Actions Secrets & Variables Synchronization Tool (2 months ago)
- [ghacts/manual-deploy-to-netlify](https://github.com/ghacts/manual-deploy-to-netlify) - GitHub Actions for manual deploying static site projects to Netlify (2 months ago)
- [ghacts/static-site](https://github.com/ghacts/static-site) - GitHub Actions for building and testing static site projects (2 months ago)
- [ansidev/awesome-nuxt](https://github.com/ansidev/awesome-nuxt) - 🎉 A curated list of awesome things related to Nuxt.js (2 months ago)
...
- [ansidev/vitepress-theme-ansidev](https://github.com/ansidev/vitepress-theme-ansidev) ([v1.0.12](https://github.com/ansidev/vitepress-theme-ansidev/releases/tag/v1.0.12), 2 months ago) - A VitePress theme for https://ansidev.xyz/
...
- [Feature: Migrate to rolldown from tsup](https://github.com/ansidev/counter-analytics-vue/pull/340) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (1 month ago)
- [feat(coplilot): add mise node detection support](https://github.com/heyhuynhgiabuu/proxypal/pull/203) on [heyhuynhgiabuu/proxypal](https://github.com/heyhuynhgiabuu/proxypal) (1 month ago)
...
- [fix: remove pnpm version to avoid failed CI/CD pipelines](https://github.com/ansidev/counter-analytics-vue/pull/333) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (2 months ago)
- [fix: remove pnpm version to avoid failed CI/CD pipelines](https://github.com/ansidev/leetcode-blog/pull/1411) on [ansidev/leetcode-blog](https://github.com/ansidev/leetcode-blog) (2 months ago)
