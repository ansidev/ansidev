...
- [Revert "chore(deps): update cirrus-actions/rebase action to v1.6"](https://github.com/ansidev/astro-basic-template/pull/576) on [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) (3 weeks ago)
