...
- [ansidev/anti-locker](https://github.com/ansidev/anti-locker) - Prevent macOS from locking the screen when connected to a specific Wi-Fi network. (today)
...
- [ansidev/anti-locker](https://github.com/ansidev/anti-locker) ([v1.0.3](https://github.com/ansidev/anti-locker/releases/tag/v1.0.3), 1 day ago) - Prevent macOS from locking the screen when connected to a specific Wi-Fi network.
- [heyhuynhgiabuu/proxypal](https://github.com/heyhuynhgiabuu/proxypal) ([v0.4.49](https://github.com/heyhuynhgiabuu/proxypal/releases/tag/v0.4.49), 1 day ago) - A desktop app that lets you use your AI subscriptions (Claude, ChatGPT, Gemini, GitHub Copilot) with any coding tool. Wraps CLIProxyAPI with a clean UI for managing connections and tracking usage.
- [ghacts/go](https://github.com/ghacts/go) ([v2.0.0](https://github.com/ghacts/go/releases/tag/v2.0.0), 2 days ago) - GitHub Actions for building and testing Go projects
- [ansidev/awesome-nuxt](https://github.com/ansidev/awesome-nuxt) ([v2.1.4](https://github.com/ansidev/awesome-nuxt/releases/tag/v2.1.4), 6 days ago) - 🎉 A curated list of awesome things related to Nuxt.js
...
- [Merge branch release/1.0.3 into develop](https://github.com/ansidev/anti-locker/pull/8) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (1 day ago)
- [Release v1.0.3](https://github.com/ansidev/anti-locker/pull/7) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (1 day ago)
- [Merge branch release/1.0.2 into develop](https://github.com/ansidev/anti-locker/pull/6) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (2 days ago)
- [Release v1.0.2](https://github.com/ansidev/anti-locker/pull/5) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (2 days ago)
- [Merge branch release/1.0.1 into develop](https://github.com/ansidev/anti-locker/pull/4) on [ansidev/anti-locker](https://github.com/ansidev/anti-locker) (2 days ago)
