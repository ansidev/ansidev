...
- [ansidev/homebrew-casks](https://github.com/ansidev/homebrew-casks) - ansidev's Homebrew Casks (2 days ago)
...
- [ansidev/blog](https://github.com/ansidev/blog) - Personal blog of ansidev (6 days ago)
...
- [ghacts/manual-deploy-to-netlify](https://github.com/ghacts/manual-deploy-to-netlify) ([v1.0.1](https://github.com/ghacts/manual-deploy-to-netlify/releases/tag/v1.0.1), 3 days ago) - GitHub Actions for manual deploying static site projects to Netlify
- [withastro/astro](https://github.com/withastro/astro) ([astro@4.1.1](https://github.com/withastro/astro/releases/tag/astro%404.1.1), 4 days ago) - The web framework that scales with you — Build fast content sites, powerful web applications, dynamic server APIs, and everything in-between ⭐️ Star to support our work!
- [astro-community/AstroCompress](https://github.com/astro-community/AstroCompress) ([v2.2.7](https://github.com/astro-community/AstroCompress/releases/tag/v2.2.7), 4 days ago) - 🗜️ AstroJS compression utilities. Compress CSS, HTML, JavaScript and more!
- [ansidev/astro-basic-template](https://github.com/ansidev/astro-basic-template) ([v3.0.0](https://github.com/ansidev/astro-basic-template/releases/tag/v3.0.0), 1 month ago) - An opinionated Astro starter template
- [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ([v4.4.1](https://github.com/akinsho/bufferline.nvim/releases/tag/v4.4.1), 1 month ago) - A snazzy bufferline for Neovim

#### 🔨 Latest Pull Requests I published

- [deps: eslint & husky](https://github.com/ansidev/counter-analytics-vue/pull/97) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (2 days ago)
- [deps: vue 3.4.5](https://github.com/ansidev/counter-analytics-vue/pull/96) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (2 days ago)
- [chore(deps): bump tsup version to ^8.0.1](https://github.com/ansidev/counter-analytics-vue/pull/95) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (2 days ago)
- [deps: typescript 5.3.3](https://github.com/ansidev/counter-analytics-vue/pull/94) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (2 days ago)
- [chore(deps): upgrade @commitlint packages to v18](https://github.com/ansidev/counter-analytics-vue/pull/93) on [ansidev/counter-analytics-vue](https://github.com/ansidev/counter-analytics-vue) (2 days ago)
